...
#region Properties
		...
		private int _previousPanelCount;
		...
		private bool ValidConfig
		{
			get
			{
				...
				if (pagination != null)
				{
					...
					{
						Debug.LogError(
							"<b>[SimpleScrollSnap]</b> The number of Toggles should be equivalent to the number of Panels. There are currently " + numberOfToggles + " Toggles and " + NumberOfPanels +
							" Panels. If you are adding Panels dynamically during runtime, please update your pagination to reflect the number of Panels you will have before adding.", gameObject);
						valid = false;
					}
				}
		...
		public void OnEndDrag(PointerEventData eventData)
		{
			...
			switch (movementAxis)
			{
				case MovementAxis.Horizontal:
					releaseDirection = _beginDragPos - eventData.position.x > 0 ? Direction.Left : Direction.Right;
					break;
