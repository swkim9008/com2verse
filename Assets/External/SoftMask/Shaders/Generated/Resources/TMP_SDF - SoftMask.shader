...
SubShader {
	...
	Pass {
		...
		#include "Assets/External/TextMesh Pro/Shaders/TMPro_Properties.cginc"
		#include "Assets/External/TextMesh Pro/Shaders/TMPro.cginc"
		#include "Assets/External/SoftMask/Shaders/Resources/SoftMask.cginc" // Soft Mask
