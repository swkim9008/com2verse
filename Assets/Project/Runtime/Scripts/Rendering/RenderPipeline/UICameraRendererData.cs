/*===============================================================
* Product:		Com2Verse
* File Name:	UICameraRendererData.cs
* Developer:	ljk
* Date:			2022-08-22 09:57
* History:		
* Documents:	
...
namespace Com2Verse.Rendering.RenderPipeline
{
	...
	public sealed class UICameraRendererData : ScriptableRendererData, ISerializationCallbackReceiver
	{
...
#pragma warning restore 0414
		...
		protected override ScriptableRenderer Create()
		{
			...
			return new UICameraRenderer(this);
		}
