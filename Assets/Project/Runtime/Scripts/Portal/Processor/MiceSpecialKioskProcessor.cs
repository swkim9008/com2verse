/*===============================================================
* Product:		Com2Verse
* File Name:	SpecialKioskProcessor.cs
* Developer:	ikyoung
* Date:			2023-06-13 18:52
* History:		
* Documents:	
...
{
	[LogicType(eLogicType.MICE_KIOSK_SPECIAL)]
	public sealed class MiceSpecialKioskProcessor : BaseLogicTypeProcessor
	{
