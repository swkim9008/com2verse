...
namespace Com2Verse.BannedWords.Zip
{
    internal class WorkItem
    {
        ...
        public WorkItem(int size,
                        Com2Verse.BannedWords.Zip.CompressionLevel compressLevel,
    ...
    public class ParallelDeflateOutputStream : System.IO.Stream
    {
        ...
        private Com2Verse.BannedWords.Zip.CompressionLevel _compressLevel;
        ...
        private void _PerpetualWriterMethod(object state)
        {
            ...
            try
            {
                do
                {
                    ...
                    Com2Verse.BannedWords.Zip.CRC32 c= new ComVerse.BannedWords.Zip.CRC32();
                    do
                    {
