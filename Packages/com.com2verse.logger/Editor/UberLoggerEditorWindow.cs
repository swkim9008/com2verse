...
using Logger = Com2Verse.Logger.UberDebug.Logger;

namespace Com2VerseEditor.DebugEditor
{
    /// <summary>
    ...
    // _OR_NEWER only became available from 5.3
        ...
        GUIContent GetLogLineGUIContent(LogInfo log, bool showTimes, bool showChannels)
        {
            ...
            showMessage = showMessage.Replace(Logger.UnityInternalNewLine, " ");
        ...
        bool JumpToSource(LogStackFrame frame)
        {
            ...
            {
                var osFileName = Logger.ConvertDirectorySeparatorsFromUnityToOS(frame.FileName);
