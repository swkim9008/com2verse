...
namespace Com2Verse.Logger.UberDebug.Examples
{
    public class TestUberLogger : MonoBehaviour
    {
        ...
        void Start ()
        {
            Logger.AddLogger(new UberLoggerFile("UberLogger.log"), false);
            DoTest();
        ...
        void TestThreadEntry()
        {
            for(;;)
            {
                UnityEngine.Debug.Log("Thread Log Message");
        ...
        public void DoTest()
        {
            ...
            UnityEngine.Debug.LogWarning("Log Warning with GameObject", gameObject);
            UnityEngine.Debug.LogError("Log Error with GameObject", gameObject);
            UnityEngine.Debug.Log("Log Message with GameObject", gameObject);
            UnityEngine.Debug.LogFormat("Log Format param {0}", "Test");
            UnityEngine.Debug.LogFormat(gameObject,             "Log Format with GameObject and param {0}", "Test");
